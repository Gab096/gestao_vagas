...
import br.com.gabriel.gestao_vagas.modules.candidate.useCases.ListAllJobsByFilterUseCases;
...
public class CandidateController {
  ...
  @Operation(summary = "perfil do candidato" , description = "essa função é responsavel por buscar o perfil do candidato")
  @ApiResponses({
    @ApiResponse(responseCode = "200", content = {
  ...
  @GetMapping("/job")
  @PreAuthorize("hasRole('CANDIDATE')")
  @Operation(summary = "Listagem de vagas disponivespara o candidato" , description = "essa função é responsavel por listar as vagas para o candidato")
  @ApiResponses(
    @ApiResponse(
      responseCode = "200",
      content = {
  ...
  public List<JobEntity> findJobByFilter(@RequestParam String filter){
    return listAllJobsByFilterUseCases.execute(filter);
  }
